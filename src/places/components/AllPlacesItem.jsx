...
const AllPlacesItem = ({ id,
    ...
    return (
        <li className="list-none">
            <Card>
                <div className="flex flex-col md:flex-row items-start gap-8 p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transition duration-300 bg-white">
                    ...
                    <div className="flex-1 w-full flex flex-col justify-between">
                        ...
                        <button className="px-5 py-2 text-sm rounded-lg bg-indigo-500 text-white hover:bg-indigo-600 transition font-medium w-fit">
                            View on Map
                        </button>
                    </div>
                </div>
